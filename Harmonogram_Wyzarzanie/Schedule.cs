...
namespace Harmonogram_Wyzarzanie
{
    public class Schedule
    {
        ...
        readonly static Dictionary<int,int> jobs_hashtable = new();
        ...
        public Schedule(List<Job> jobs, int num_processors, List<int> order_of_jobs, bool can_processors_be_idle = true)
        {
            ...
            processors = Get_new_processors(this.num_processors);
        ...
        public void Add_jobs_to_processors()
        {
            ...
            // W GetProcessorWithDependencies ustawiany dodatkowy argument mówi, że
