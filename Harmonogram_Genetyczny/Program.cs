...
namespace Harmonogram_Genetyczny
{
    class Program
    {
        ...
        static void Main()
        {
            //zmienne do algorytmu genetycznego
            ...
            Scheduler scheduler = new(jobs, num_processors, population_size, generations);

            // Uloz harmonogram, za pomocą algorytmu genetycznego
